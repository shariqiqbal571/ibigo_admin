...
namespace App\Http\Controllers\Admin\CheckInPost;
...
class CheckInPostController extends Controller
{
    private $time;
    ...
    public function index()
    {
        ...
        //  exit(); 
         ...
         return view('admin/checkin-post/view')->with(compact('posts'));
    }
    ...
    public function show($unique,$id)
    {
       ...
       $like['count_comment'] = [];
        ...
        return view('admin/checkin-post/show')->with(compact('posts','like','previous'));
    }
    ...
    {
        Post::find($id)->delete();
        return redirect('/admin/checkin-post')->with('msg','Check In Post Delete Successfully.');
    }

    public function commentDelete($id)
    {
        PostComment::find($id)->delete();
        return redirect('/admin/checkin-post')->with('msg','User Comment Delete Successfully.');
    }
}
