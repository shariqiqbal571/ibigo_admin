...
class InterestController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin/interest/view')->with(compact('interests'));
    }
    ...
    public function create()
    {
        ...
        // print_r($fa_array);
        // exit();
        return view('admin/interest/add')->with(compact('fa_array'));
    ...
    public function store(Request $request)
    {
        ...
        $interests->title = $request->title;
        $interests->description = $request->description;
        $interests->unique_id = Str::random(32);
        $interests->icon = $request->icon;
        $interests->status = $request->status;
        $interests->show_in = $request->show_in;
       
         if($request->hasfile('image')){
            $destination = 'public/images/interests';
            $interest_photo = $request->file('image');
            $interestphoto = uniqid().$interest_photo->getClientOriginalName();
            $path = $interest_photo->storeAs($destination,$interestphoto);
            $interests->image = $interestphoto;
        }
        
        $interests->save();
        return redirect('/admin/interest')->with('msg','Create  Interest Successfully.');
    }  
        else
        {
    ...
    public function show($id)
    {
        ...
        // return view('admin/interest/show')->with(compact('interests'));
    }
    ...
    {
        $interests = Interest::where('unique_id',$id)->get()->toArray();
        $fa_array = $this->fa_array;
        // echo "<pre>";
        // print_r($interests);
        // exit();
        return view('admin/interest/update')->with(compact('interests','fa_array'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $interests->save();
        return redirect('/admin/interest')->with('msg','Update  Interest Successfully.');
    }
        else{
            return back()->withErrors($validator)->withInput();
        }
    ...
    public function destroy($id)
    {
        ...
        return redirect('/admin/interest')->with('msg','Interest delete Successfully.');
    }
}
