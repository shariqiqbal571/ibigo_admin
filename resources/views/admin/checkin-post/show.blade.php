        ...
        <div class="table-responsive">
            <div class="card">
                <div class="header">
                    <div class="row">
                        <div class="col-sm-10">
                            <h2>Check In Post Information</h2>
                        </div></br>
                    </div>
                </div>
                <div class="body">
                                        ...
                                        <div class="col-sm-10" style="padding-left: 0 !important">
                                            ...
                                            <div class="body">
                                               {{$post['comment'] }}
                                                ...
                                                <a style="padding-top: 5px;" class="badge rounded-pill btn btn-danger" href="{{ url('/admin/checkin-post/comment/delete/'.$post['id'])}}" ><span>Delete</span></a>                 
                                            </div>
                                        </div>
                                    </div>
                                </div>
